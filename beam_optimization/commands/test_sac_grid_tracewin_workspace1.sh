#!/usr/bin/env bash
# Qualitatively test all 30 completed SAC grid policies for one 20-step TraceWin episode.
set -euo pipefail
...
TEST_ROOT="beam_optimization/results/test/sac_penalty_horizon_grid_tracewin_workspace1_1episode_20steps_final_render"
